...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, LivecoinUnits::SeparatorStyle separators=LivecoinUnits::separatorStandard) const;
