...
/** Livecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LivecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LivecoinUnits(QObject *parent);

    /** Livecoin units.
      @note Source: https://en.livecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LVC,
...
typedef LivecoinUnits::Unit LivecoinUnit;
