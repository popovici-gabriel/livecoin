...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<LivecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_livecoin-qt -platform xcb      # Linux
//     src/qt/test/test_livecoin-qt -platform windows  # Windows
//     src/qt/test/test_livecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = LivecoinUnits::formatWithUnit(unit, balance, false, LivecoinUnits::separatorAlways);
    ...
    // Amount input
    LivecoinAmountField* amountInput = receiveCoinsDialog.findChild<LivecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: livecoin:")) != -1);
