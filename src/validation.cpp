...
#if defined(NDEBUG)
# error "Livecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Livecoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s LVC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("livecoin-scriptch");
