// Copyright (c) 2015-2017 The Livecoin Core developers
...
{
    RenameThread("livecoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/livecoin/livecoin/pull/6990)
