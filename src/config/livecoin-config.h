/* src/config/livecoin-config.h.  Generated from livecoin-config.h.in by configure.  */
/* src/config/livecoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "Bitcoin Core 0.16.1"
